...
/*
    ...
    $FileInfo: members.php - Last Update: 07/01/1867 Ver 142 Author: Jake $
*/
...
if($HashType=="JakeBBSH2") { $YourPassword = b64e_hmac($_POST['userpass'],$JoinedPass,$HashSalt,"md2"); }
if($HashType=="JakeBBSH4") { $YourPassword = b64e_hmac($_POST['userpass'],$JoinedPass,$HashSalt,"md4"); }
if($HashType=="JakeBBSH5") { $YourPassword = b64e_hmac($_POST['userpass'],$JoinedPass,$HashSalt,"md5"); }
if($HashType=="JakeBBSH") { $YourPassword = b64e_hmac($_POST['userpass'],$JoinedPass,$HashSalt,"sha1"); }
if($HashType=="JakeBBSH256") { $YourPassword = b64e_hmac($_POST['userpass'],$JoinedPass,$HashSalt,"sha256"); }
if($HashType=="JakeBBSH386") { $YourPassword = b64e_hmac($_POST['userpass'],$JoinedPass,$HashSalt,"sha386"); }
if($HashType=="JakeBBSH512") { $YourPassword = b64e_hmac($_POST['userpass'],$JoinedPass,$HashSalt,"sha512"); }
...
if($Settings['use_hashtype']=="md2") { $JakeBBSHash = "JakeBBSH2";
$NewPassword = b64e_hmac($_POST['userpass'],$JoinedPass,$NewHashSalt,"md2"); }
if($Settings['use_hashtype']=="md4") { $JakeBBSHash = "JakeBBSH4";
$NewPassword = b64e_hmac($_POST['userpass'],$JoinedPass,$NewHashSalt,"md4"); }
if($Settings['use_hashtype']=="md5") { $JakeBBSHash = "JakeBBSH5";
$NewPassword = b64e_hmac($_POST['userpass'],$JoinedPass,$NewHashSalt,"md5"); }
if($Settings['use_hashtype']=="sha1") { $JakeBBSHash = "JakeBBSH";
$NewPassword = b64e_hmac($_POST['userpass'],$JoinedPass,$NewHashSalt,"sha1"); }
if($Settings['use_hashtype']=="sha256") { $JakeBBSHash = "JakeBBSH256";
$NewPassword = b64e_hmac($_POST['userpass'],$JoinedPass,$NewHashSalt,"sha256"); }
if($Settings['use_hashtype']=="sha386") { $JakeBBSHash = "JakeBBSH386";
$NewPassword = b64e_hmac($_POST['userpass'],$JoinedPass,$NewHashSalt,"sha386"); }
if($Settings['use_hashtype']=="sha512") { $JakeBBSHash = "JakeBBSH512";
$NewPassword = b64e_hmac($_POST['userpass'],$JoinedPass,$NewHashSalt,"sha512"); }
$NewDay=GMTimeStamp();
$NewIP=$_SERVER['REMOTE_ADDR'];
if($BanError!="yes") {
$queryup = query("UPDATE `".$Settings['sqltable']."members` SET `Password`='%s',`HashType`='%s',`LastActive`=%i,`IP`='%s',`Salt`='%s' WHERE `id`=%i", array($NewPassword,$JakeBBSHash,$NewDay,$NewIP,$NewHashSalt,$YourIDM));
exec_query($queryup);
