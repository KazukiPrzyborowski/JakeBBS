...
$VER1[0] = 1; $VER1[1] = 4; $VER1[2] = 2; $VERFull[1] = $VER1[0].".".$VER1[1].".".$VER1[2];
$VER2[0] = "Omega"; $VER2[1] = "Omega"; $VER2[2] = "Ver"; $SubVerN = 142; $RName = "JakeBBS"; $SFName = "JakeBBS";
...
$VerInfo['JakeBBS_Ver_Show'] = $VerInfo['JakeBBS_Ver']; $VerInfo['JakeBBS_Full_Ver_Show'] = $VerInfo['JakeBBS_Ver'];
// URLs and names and stuff. :P $KSP = "Jake Sabonis ";
$VerCheckURL = "http://google.com/search?q=JakeBBS+Inc.&amp;btnI=I%27m+Feeling+Lucky";
$CD2k = "Jake "; $GM2k = "JakeBBS Inc."; $JakeBBS_Author = "Jake";
$JakeBBS = "Internet Discussion Boards"; $iTB = "Internet Tag Boards"; $DF2k = "Discussion Forums 2k"; $TB2k = "Tag Boards 2k";
$JakeBBSURL1 = "<a href=\"http://google.com/search?q=JakeBBS+Inc.&amp;btnI=I%27m+Feeling+Lucky\" onclick=\"window.open(this.href);return false;\">"; $JakeBBSURL2 = $JakeBBSURL1.$JakeBBS."</a>";
