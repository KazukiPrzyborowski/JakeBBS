...
/*
    ...
    $FileInfo: setcheck.php - Last Update: 07/01/1867 Ver 142 Author: Jake $
*/
...
if($Settings['enable_rss']=="on") { 
    $Settings['enable_rss'] = "on"; }
if (file_exists("themes/JakeBBS/settings.php")) {
	$FallBack['DefaultTheme'] = "JakeBBS"; }
if (!file_exists("themes/JakeBBS/settings.php")) {
...
$jakebbspowertitle = " (Powered by ".$JakeBBS.")";
$itbpowertitle = " (Powered by ".$iTB.")"; }
if($Settings['add_power_by']!="on") {
$jakebbspowertitle = null;
$itbpowertitle = null; }
...
if ($_GET['act']=="JakeBBSInfo") { @header('Location: http://sourceforge.net/projects/jakebbs/'); }
if ($_GET['act']=="JakeBBSSite") { @header('Location: http://jakebbs.sourceforge.net/'); }
if ($_GET['act']=="OldJakeBBSInfo") { @header('Location: http://developer.berlios.de/projects/jakebbs/'); }
if ($_GET['act']=="OldJakeBBSSite") { @header('Location: http://google.com/search?q=JakeBBS+Inc.&btnI=I%27m+Feeling+Lucky'); }
...
if ($_GET['act']=="GM2kSite") { @header('Location: http://upload.jakebbs.s1.jcink.com/'); }
?>
