...
if ($_GET['act'] == "JakeBBSInfo") {
    @header('Location: http://sourceforge.net/projects/jakebbs/');
}
if ($_GET['act'] == "JakeBBSSite") {
    @header('Location: http://jakebbs.sourceforge.net/');
}
if ($_GET['act'] == "OldJakeBBSInfo") {
    @header('Location: http://developer.berlios.de/projects/jakebbs/');
}
if ($_GET['act'] == "OldJakeBBSSite") {
    @header('Location: http://google.com/search?q=JakeBBS+Inc.&btnI=I%27m+Feeling+Lucky');
}
...
if ($_GET['act'] == "GM2kSite") {
    @header('Location: http://upload.jakebbs.s1.jcink.com/');
}
