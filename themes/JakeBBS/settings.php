...
/*
    ...
    Copyright 2004-2008 Cool Dude 2k - http://google.com/search?q=JakeBBS+Inc.&btnI=I%27m+Feeling+Lucky
    Copyright 2004-2008 Game Maker 2k - http://google.com/search?q=JakeBBS+Inc.&btnI=I%27m+Feeling+Lucky
    $ThemeInfo - Name: JakeBBS Theme - Author: Jake $
    $FileInfo: settings.php - Last Update: 07/01/1867 Ver 142 Author: Jake $
*/
$ThemeSet = array();
$ThemeSet['ThemeName'] = "JakeBBS Theme";
$ThemeSet['ThemeMaker'] = "Jake";
$ThemeSet['ThemeVersion'] = "1.4.2";
$ThemeSet['ThemeVersionType'] = "Omega";
$ThemeSet['ThemeSubVersion'] = "Ver 142";
$ThemeSet['MakerURL'] = "http://google.com/search?q=JakeBBS+Inc.&amp;btnI=I%27m+Feeling+Lucky";
...
$ThemeSet['CSS'] = "themes/JakeBBS/css.css";
$ThemeSet['CSSType'] = "include";
$ThemeSet['FavIcon'] = "themes/JakeBBS/favicon.ico";
