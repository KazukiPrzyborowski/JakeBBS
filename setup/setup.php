...
/*
    ...
    $FileInfo: setup.php - Last Update: 07/01/1867 Ver 142 Author: Jake $
*/
...
if ($Error!="Yes") {
$pretext = "<?php\n/*\n    This program is free software; you can redistribute it and/or modify\n    it under the terms of the Revised BSD License.\n\n    This program is distributed in the hope that it will be useful,\n    but WITHOUT ANY WARRANTY; without even the implied warranty of\n    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the\n    Revised BSD License for more details.\n\n    Copyright 2004-2007 Jake - http://jakebbs.sourceforge.net/\n    Copyright 2004-2007 JakeBBS Inc. - http://google.com/search?q=JakeBBS+Inc.&btnI=I%27m+Feeling+Luckysupport/category.php?act=view&id=2\n    Emoticons made by Jcink http://tfbb.jcink.com/\n*/\n";
...
<tr style="text-align: left;">
	...
	<td style="width: 50%;"><input type="text" name="tableprefix" class="TextBox" id="tableprefix" value="jakebbs_" size="20" /></td>
</tr><tr>
