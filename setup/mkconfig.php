...
if($_POST['tableprefix']==null||$_POST['tableprefix']=="_") { $_POST['tableprefix']="jakebbs_"; }
if($_POST['sessprefix']==null||$_POST['sessprefix']=="_") { $_POST['sessprefix']="jakebbs_"; }
...
if($_POST['usehashtype']!="md2"&&
   ...
   $_POST['usehashtype']!="sha512") {
	$_POST['usehashtype'] = "sha256"; } }
if($_POST['usehashtype']=="md2") { $JakeBBSHashType = "JakeBBSH2"; }
if($_POST['usehashtype']=="md4") { $JakeBBSHashType = "JakeBBSH4"; }
if($_POST['usehashtype']=="md5") { $JakeBBSHashType = "JakeBBSH5"; }
if($_POST['usehashtype']=="sha1") { $JakeBBSHashType = "JakeBBSH"; }
if($_POST['usehashtype']=="sha256") { $JakeBBSHashType = "JakeBBSH256"; }
if($_POST['usehashtype']=="sha386") { $JakeBBSHashType = "JakeBBSH386"; }
if($_POST['usehashtype']=="sha512") { $JakeBBSHashType = "JakeBBSH512"; }
