...
echo "500 Error: URL is malformed. Try reinstalling JakeBBS."; die(); }
...
echo "403 Error: Sorry could not find install.php\nTry uploading files again and if that dose not work try download JakeBBS again."; die(); } }
...
<?php echo "<name>JakeBBS|".$VER2[1]."|".$VER1[0].".".$VER1[1].".".$VER1[2]."|".$VER2[2]."|".$SubVerN."</name>"; die(); }
...
if($Settings['jakebbsurl']!=null&&$Settings['jakebbsurl']!="localhost") {
$HTTPsTest = parse_url($Settings['jakebbsurl']); if($HTTPsTest['scheme']=="http") {
...
$_GET['theme']="JakeBBS"; $_SESSION['Theme']="JakeBBS"; }
